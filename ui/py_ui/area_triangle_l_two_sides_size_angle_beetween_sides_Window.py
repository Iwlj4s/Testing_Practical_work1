...
class Ui_area_triangle_l_two_sides_size_angle_beetween_sides_Window(object):
    def setupUi(self, area_triangle_l_two_sides_size_angle_beetween_sides_Window):
        ...
        area_triangle_l_two_sides_size_angle_beetween_sides_Window.resize(811, 470)
        ...
        self.formLayoutWidget.setGeometry(QRect(240, 170, 321, 171))
        ...
        self.input_frame.setWidget(3, QFormLayout.FieldRole, self.area_triangle_l_two_sides_size_angle_beetween_sides_result_button)
